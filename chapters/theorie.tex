...
Um diese Beziehung zu verändern definieren wir die sog. \textit{Embedding Strength}\index{Embedding Strength} $ES$, eine Entscheidungsvariable um den logischen Wert 0 oder 1 zu beschreiben. Die Embedding Strength berechnet sich wie folgt:
	\begin{equation}
